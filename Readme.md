...
> **This is not a standalone mod.** You must have Distant Horizons, VulkanMod, AND Beryl installed. Get the latest versions as of Aug 6th, 2026. Tested for Minecraft version 26.1.2 with the default texture pack. I recommend installing **Not Enough Vulkan** and **Bobby** to avoid broken atmospheric fog and improve server chunk render distances. Please use _my_ v26.1 alterations of those mods, which can be found on my [GitHub](https://github.com/cwright814?tab=repositories).
